    ...
    @section('content')
        ...
        <div class="ml-2 mt-2 pb-0 mb-0 bg-white rounded-t-2xl">
            <a class="inline-flex items-center px-2 py-2 my-4 ml-2 text-sm font-bold text-center text-white transition-all ease-in border-0 rounded-lg shadow-soft-md bg-orange-400 hover:shadow-soft-2xl hover:scale-102"
             ...
             <!-- Input Pencarian -->
            <input type="text" id="searchInput" placeholder="Cari produk..." class="border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 w-64"/>

            <!-- Filter Kategori -->
            <select id="categoryFilter" class="border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-400 w-64">
